...
// ← Cloudflare Pages URL'nizi buraya girin (örn: https://ogretmenim.pages.dev)
private let kBaseURL = "https://ogretmenim.pages.dev"
...
class WebViewController: UIViewController {
    ...
    private let accentColor = UIColor(red: 46/255, green: 160/255, blue: 67/255, alpha: 1)
    private let bgColor     = UIColor(red: 13/255, green: 17/255, blue: 23/255, alpha: 1)
